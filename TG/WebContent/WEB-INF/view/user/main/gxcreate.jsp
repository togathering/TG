		...
		<section id="container">
			...
			<form name="createFrm" id="hongkiat-form" method="post" action="gxcreate" enctype="multipart/form-data">
				...
				var d = 0;
						...
						<input type="button" class="button" onclick="searchAddress()" value="장소선택"><br><br>
						...
						<input type="text" name="title" id="title"
							placeholder="제목 ex) 같이 달리실 분" autocomplete="on" tabindex=""
							class="txtinput" style="font-size: 15px; margin-bottom: 2px;">
