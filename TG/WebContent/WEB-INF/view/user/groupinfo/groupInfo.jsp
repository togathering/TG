...
<script type="text/javascript">
	...
	function profile() {
		window.open('profile', '', 'width=300, height=400');
	}
	...
	<div>
		...
		<div style="padding:5px 8% 5px 3%; float:right; width:39%; height: 400px;">		
			...
			<div>
				...
				<table>
					<tr>
						<td width="100px"><a onclick="window.open('profile?id=${group.ghost }', '', 'width=930, height=550, screenX=200, screenY=100');"  style="color: red" >${group.ghost }</a></td>
						<td width="100px">그룹 호스트</td>
					</tr>
					<c:forEach  items='${joinlist}' var='list' >
						<tr>
							<td><a href="javascript:void(0)" onclick="window.open('profile?id=${list.pid}', '', 'width=930, height=550, screenX=200, screenY=100');" style="color: blue">${list.pid }</a></td>
