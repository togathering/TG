...
update report1 set reporter = '(Å»ÅğÈ¸¿ø)'||TO_CHAR(SYSDATE,'YYMMDD')||delmember.nextval where reporter= delid;
update report1 set accused= '(Å»ÅğÈ¸¿ø)'||TO_CHAR(SYSDATE,'YYMMDD')||delmember.nextval where accused= delid;
